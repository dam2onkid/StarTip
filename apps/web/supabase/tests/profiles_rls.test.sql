...
select col_is_null('public', 'profiles', 'owner_address', 'owner_address is nullable');
select col_is_null('public', 'profiles', 'payout_address', 'payout_address is nullable');
select col_not_null('public', 'profiles', 'onchain_registered', 'onchain_registered is NOT NULL');
select col_not_null('public', 'profiles', 'paused', 'paused is NOT NULL');
